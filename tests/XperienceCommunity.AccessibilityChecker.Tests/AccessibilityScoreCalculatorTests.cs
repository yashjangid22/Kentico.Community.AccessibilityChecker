...
{
    [Test]
    public void Calculate_NoIssues_ReturnsFullScore() => Assert.That(AccessibilityScoreCalculator.Calculate(0, 0, 0, 0), Is.EqualTo(100));
    ...
    [Test]
    public void Calculate_LargeDeduction_ClampsAtZero() => Assert.That(AccessibilityScoreCalculator.Calculate(criticalRuleCount: 20, seriousRuleCount: 0, moderateRuleCount: 0, minorRuleCount: 0), Is.EqualTo(0));
}
